    ...
    <div class="flex min-h-screen bg-gray-50">
       ...
       <x-isler.side-navbar :isler="$isler" />
        ...
        <main class="flex-1 p-6 bg-gray-100">
            <h1 class="text-2xl font-bold text-gray-800 mb-6">Teklifler</h1>

            {{-- Mevcut teklif listesi burada yer alacak --}}
            <div class="max-w-7xl mx-auto py-10 sm:px-6 lg:px-8">
                ...
                <div class="flex justify-between items-center mb-6">
                    ...
                    <a href="{{ route('isler.teklifler.create', ['isler' => $isler->id]) }}" class="inline-flex items-center px-4 py-2 bg-gradient-to-r from-blue-500 to-blue-600 text-white text-sm font-medium rounded-md shadow hover:from-blue-600 hover:to-blue-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 transition">
                        Yeni Teklif Ekle
                    </a>
                </div>
